...
static const EIF_TYPE_INDEX egt_13_964 [] = {0xFF01,965,0xFF01,960,0xFFFF};
static const EIF_TYPE_INDEX egt_14_964 [] = {0xFF01,965,0xFF01,960,0xFFFF};
...
static const struct desc_info desc_964[] = {
	...
	{EIF_NON_GENERIC(0x01B5 /*218*/), 13485, 16},
	{EIF_GENERIC(egt_13_964), 13486, 0},
	{EIF_GENERIC(egt_14_964), 13487, 8},
	{EIF_GENERIC(NULL), 13488, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0197 /*203*/), 13489, 0xFFFFFFFF},
};
void Init964(void)
{
	IDSC(desc_964, 0, 963);
	IDSC(desc_964 + 1, 1, 963);
	IDSC(desc_964 + 32, 364, 963);
	IDSC(desc_964 + 36, 366, 963);
}
