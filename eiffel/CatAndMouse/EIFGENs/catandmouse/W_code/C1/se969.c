...
extern EIF_TYPED_VALUE F969_2482(EIF_REFERENCE);
...
EIF_TYPED_VALUE F969_2482 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 968, Current, 0, 0, 13495);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(968, Current, 13495);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2210, dtype))(Current)).it_b);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
