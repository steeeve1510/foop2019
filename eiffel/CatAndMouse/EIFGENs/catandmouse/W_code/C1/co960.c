...
void F960_7191 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 4980, 0x10000000, 1); /* subway_counter */
	*(EIF_INTEGER_32 *)(Current + RTWA(4980, Dtype(Current))) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F960_7192 (EIF_REFERENCE Current)
{
	...
	Result = *(EIF_INTEGER_32 *)(Current + RTWA(4980, dtype));
	RTHOOK(2);
	RTDBGAA(Current, dtype, 4980, 0x10000000, 1); /* subway_counter */
