...
struct eif_ex_251 {union overhead overhead; char data [8];};
struct eif_ex_527 {union overhead overhead; char data [8];};
struct eif_ex_531 {union overhead overhead; char data [8];};
struct eif_ex_575 {union overhead overhead; char data [8];};
struct eif_ex_581 {union overhead overhead; char data [8];};
struct eif_ex_585 {union overhead overhead; char data [8];};
struct eif_ex_589 {union overhead overhead; char data [8];};
struct eif_ex_593 {union overhead overhead; char data [8];};
struct eif_ex_597 {union overhead overhead; char data [8];};
struct eif_ex_605 {union overhead overhead; char data [8];};
struct eif_ex_611 {union overhead overhead; char data [8];};
struct eif_ex_819 {union overhead overhead; char data [8];};
struct eif_ex_834 {union overhead overhead; char data [8];};
struct eif_ex_838 {union overhead overhead; char data [8];};
struct eif_ex_843 {union overhead overhead; char data [8];};
